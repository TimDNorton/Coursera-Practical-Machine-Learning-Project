...
output$documentation<-renderText({"This application supports developing a data model that determines chick weight
    by diet and over a period of time. The user can pick which attributes to include in a linear of multilinear
    regression model or a support vector machine model to understant the data and make further
    decisions about building a better model from this data. When features are chosen, the application
    reactively changes all analysis to the new model. 
    
    There are several tabs that show
    different analysis. The first tab shows the dataset data summary and correlation matrix 
    of the various features in the dataset. The second tab shows information about the model fit and the third
    shows percentage error of the model on the test set. The last tab shows residual plots of
    the model fit in order to determine how the model can be improved after viewing the initial
    information of the shiny app."})
}
